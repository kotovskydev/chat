...
<body >
	...
	<div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
		<div class="d-flex col-md-5 justify-content-center align-items-center mainblock flex-column"  >
			...
			<h1 style="font-size: 24px;">Регистрация</h1>
			<div class="col-12">
			 	<form style="margin-bottom: 10px;" id="form">
			 		...
			 		<input type="password" name="password" id="password"  readonly="readonly" onfocus="this.removeAttribute('readonly');" placeholder="Введите пароль" required>
			 		<div style="height: 20px;" class="formerror">
			 			<p  id="passerror"></p>
			 		</div>
			...
			<div class="col-12 d-flex justify-content-between align-items-center">
				<p></p>
				<a href="/login" class="nnchat">У меня уже есть аккаунт</a>
			</div>
		</div>
	</div>
		    ...
		    $.ajax({
	            ...
	            success: function(data) {
	            	if (data != 'busy') {
	            		...
	            		nameerror.innerHTML = 'Данное имя занято';
	            	}
